...
class Window {
  ...
  String _defaultRouteName() { throw new UnimplementedNativeFunctionError(); }
  ...
  ///  * [SchedulerBinding], the Flutter framework class which manages the
  ///    scheduling of frames.
  void scheduleFrame() { throw new UnimplementedNativeFunctionError(); }
  ...
  ///  * [RendererBinding], the Flutter framework class which manages layout and
  ///    painting.
  void render(Scene scene) { throw new UnimplementedNativeFunctionError(); }
  ...
  void updateSemantics(SemanticsUpdate update) { throw new UnimplementedNativeFunctionError(); }
  ...
  String _sendPlatformMessage(String name,
                              PlatformMessageResponseCallback callback,
                              ByteData data) { throw new UnimplementedNativeFunctionError(); }
