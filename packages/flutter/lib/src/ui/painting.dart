...
class Image {
  ...
  int get width { throw new UnimplementedNativeFunctionError(); }

  /// The number of image pixels along the image's vertical axis.
  int get height { throw new UnimplementedNativeFunctionError(); }
  ...
  String _toByteData(int format, _Callback<Uint8List> callback) { throw new UnimplementedNativeFunctionError(); }
...
class FrameInfo {
  ...
  int get _durationMillis { throw new UnimplementedNativeFunctionError(); }

  /// The [Image] object for this frame.
  Image get image { throw new UnimplementedNativeFunctionError(); }
}
...
class Codec {
  ...
  int get frameCount { throw new UnimplementedNativeFunctionError(); }

  /// Number of times to repeat the animation.
  ///
  /// * 0 when the animation should be played once.
  /// * -1 for infinity repetitions.
  int get repetitionCount { throw new UnimplementedNativeFunctionError(); }
  ...
  /// Returns an error message on failure, null on success.
  String _getNextFrame(_Callback<FrameInfo> callback) { throw new UnimplementedNativeFunctionError(); }
...
class Path {
  ...
  Path _clone() { throw new UnimplementedNativeFunctionError(); }
  ...
  int _getFillType() { throw new UnimplementedNativeFunctionError(); }
  void _setFillType(int fillType) { throw new UnimplementedNativeFunctionError(); }

  /// Starts a new subpath at the given coordinate.
  void moveTo(double x, double y) { throw new UnimplementedNativeFunctionError(); }

  /// Starts a new subpath at the given offset from the current point.
  void relativeMoveTo(double dx, double dy) { throw new UnimplementedNativeFunctionError(); }

  /// Adds a straight line segment from the current point to the given
  /// point.
  void lineTo(double x, double y) { throw new UnimplementedNativeFunctionError(); }

  /// Adds a straight line segment from the current point to the point
  /// at the given offset from the current point.
  void relativeLineTo(double dx, double dy) { throw new UnimplementedNativeFunctionError(); }

  /// Adds a quadratic bezier segment that curves from the current
  /// point to the given point (x2,y2), using the control point
  /// (x1,y1).
  void quadraticBezierTo(double x1, double y1, double x2, double y2) { throw new UnimplementedNativeFunctionError(); }

  /// Adds a quadratic bezier segment that curves from the current
  /// point to the point at the offset (x2,y2) from the current point,
  /// using the control point at the offset (x1,y1) from the current
  /// point.
  void relativeQuadraticBezierTo(double x1, double y1, double x2, double y2) { throw new UnimplementedNativeFunctionError(); }

  /// Adds a cubic bezier segment that curves from the current point
  /// to the given point (x3,y3), using the control points (x1,y1) and
  /// (x2,y2).
  void cubicTo(double x1, double y1, double x2, double y2, double x3, double y3) { throw new UnimplementedNativeFunctionError(); }

  /// Adds a cubic bezier segment that curves from the current point
  /// to the point at the offset (x3,y3) from the current point, using
  /// the control points at the offsets (x1,y1) and (x2,y2) from the
  /// current point.
  void relativeCubicTo(double x1, double y1, double x2, double y2, double x3, double y3) { throw new UnimplementedNativeFunctionError(); }
  ...
  void conicTo(double x1, double y1, double x2, double y2, double w) { throw new UnimplementedNativeFunctionError(); }
  ...
  void relativeConicTo(double x1, double y1, double x2, double y2, double w) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _arcTo(double left, double top, double right, double bottom,
              double startAngle, double sweepAngle, bool forceMoveTo) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _arcToPoint(double arcEndX, double arcEndY, double radiusX,
                   ...
                   bool clockwise) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _addRect(double left, double top, double right, double bottom) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _addOval(double left, double top, double right, double bottom) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _addArc(double left, double top, double right, double bottom,
               double startAngle, double sweepAngle) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _addPolygon(Float32List points, bool close) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _addRRect(Float32List rrect) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _addPath(Path path, double dx, double dy) { throw new UnimplementedNativeFunctionError(); }
  void _addPathWithMatrix(Path path, double dx, double dy, Float64List matrix) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _extendWithPath(Path path, double dx, double dy) { throw new UnimplementedNativeFunctionError(); }
  void _extendWithPathAndMatrix(Path path, double dx, double dy, Float64List matrix) { throw new UnimplementedNativeFunctionError(); }

  /// Closes the last subpath, as if a straight line had been drawn
  /// from the current point to the first point of the subpath.
  void close() { throw new UnimplementedNativeFunctionError(); }

  /// Clears the [Path] object of all subpaths, returning it to the
  /// same state it had when it was created. The _current point_ is
  /// reset to the origin.
  void reset() { throw new UnimplementedNativeFunctionError(); }
  ...
  bool _contains(double x, double y) { throw new UnimplementedNativeFunctionError(); }
  ...
  Path _shift(double dx, double dy) { throw new UnimplementedNativeFunctionError(); }
  ...
  Path _transform(Float64List matrix4) { throw new UnimplementedNativeFunctionError(); }
  ...
  Float32List _getBounds() { throw new UnimplementedNativeFunctionError(); }
  ...
  bool _op(Path path1, Path path2, int operation) { throw new UnimplementedNativeFunctionError(); }
...
class PathMetric {
  ...
  void _constructor(Path path, bool forceClosed) { throw new UnimplementedNativeFunctionError(); }

  /// Return the total length of the current contour.
  double get length { throw new UnimplementedNativeFunctionError(); }
  ...
  Float32List _getPosTan(double distance) { throw new UnimplementedNativeFunctionError(); }
  ...
  Path extractPath(double start, double end, {bool startWithMoveTo: true}) { throw new UnimplementedNativeFunctionError(); }
  ...
  /// otherwise.
  bool get isClosed { throw new UnimplementedNativeFunctionError(); }
  ...
  bool _moveNext() { throw new UnimplementedNativeFunctionError(); }
}
...
class ImageFilter {
  ...
  void _initBlur(double sigmaX, double sigmaY) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _initMatrix(Float64List matrix4, int filterQuality) { throw new UnimplementedNativeFunctionError(); }
}
...
class Gradient extends Shader {
  ...
  void _initLinear(Float32List endPoints, Int32List colors, Float32List colorStops, int tileMode) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _initRadial(double centerX, double centerY, double radius, Int32List colors, Float32List colorStops, int tileMode, Float64List matrix4) { throw new UnimplementedNativeFunctionError(); }
  void _initConical(double startX, double startY, double startRadius, double endX, double endY, double endRadius, Int32List colors, Float32List colorStops, int tileMode, Float64List matrix4) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _initSweep(double centerX, double centerY, Int32List colors, Float32List colorStops, int tileMode, double startAngle, double endAngle, Float64List matrix) { throw new UnimplementedNativeFunctionError(); }
...
class ImageShader extends Shader {
  ...
  void _constructor() { throw new UnimplementedNativeFunctionError(); }
  void _initWithImage(Image image, int tmx, int tmy, Float64List matrix4) { throw new UnimplementedNativeFunctionError(); }
}
...
class Vertices {
  ...
  void _init(int mode,
             ...
             Float32List textureCoordinates,
             Int32List colors,
             Int32List indices) { throw new UnimplementedNativeFunctionError(); }
}
...
class Canvas {
  ...
  void save() { throw new UnimplementedNativeFunctionError(); }
  ...
  void _saveLayer(double left,
                  ...
                  ByteData paintData) { throw new UnimplementedNativeFunctionError(); }
  ...
  void restore() { throw new UnimplementedNativeFunctionError(); }
  ...
  int getSaveCount() { throw new UnimplementedNativeFunctionError(); }

  /// Add a translation to the current transform, shifting the coordinate space
  /// horizontally by the first argument and vertically by the second argument.
  void translate(double dx, double dy) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _scale(double sx, double sy) { throw new UnimplementedNativeFunctionError(); }

  /// Add a rotation to the current transform. The argument is in radians clockwise.
  void rotate(double radians) { throw new UnimplementedNativeFunctionError(); }
  ...
  /// origin.
  void skew(double sx, double sy) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _transform(Float64List matrix4) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _clipRect(double left,
                 ...
                 double right,
                 double bottom,
                 int clipOp) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _clipRRect(Float32List rrect) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _clipPath(Path path) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _drawColor(int color, int blendMode) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _drawPaint(List<dynamic> paintObjects, ByteData paintData) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _drawPicture(Picture picture) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _drawPoints(List<dynamic> paintObjects,
                   ByteData paintData,
                   int pointMode,
                   Float32List points) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _drawAtlas(List<dynamic> paintObjects,
                  ...
                  Int32List colors,
                  int blendMode,
                  Float32List cullRect) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _drawShadow(Path path,
                   int color,
                   double elevation,
                   bool transparentOccluder) { throw new UnimplementedNativeFunctionError(); }
}
...
class Picture {
  ...
  Image toImage(int width, int height) { throw new UnimplementedNativeFunctionError(); }
  ...
  int get approximateBytesUsed { throw new UnimplementedNativeFunctionError(); }
}
...
class PictureRecorder {
  ...
  bool get isRecording { throw new UnimplementedNativeFunctionError(); }
  ...
  Picture endRecording() { throw new UnimplementedNativeFunctionError(); }
}
