...
class _Logger {
  static void _printString(String s) { throw new UnimplementedNativeFunctionError(); }
}
...
dynamic _saveCompilationTrace() { throw new UnimplementedNativeFunctionError(); }

void _scheduleMicrotask(void callback()) { throw new UnimplementedNativeFunctionError(); }
