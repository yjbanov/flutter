...
class Paragraph {
  ...
  double get width { throw new UnimplementedNativeFunctionError(); }

  /// The amount of vertical space this paragraph occupies.
  ///
  /// Valid only after [layout] has been called.
  double get height { throw new UnimplementedNativeFunctionError(); }

  /// The minimum width that this paragraph could be without failing to paint
  /// its contents within itself.
  ///
  /// Valid only after [layout] has been called.
  double get minIntrinsicWidth { throw new UnimplementedNativeFunctionError(); }

  /// Returns the smallest width beyond which increasing the width never
  /// decreases the height.
  ///
  /// Valid only after [layout] has been called.
  double get maxIntrinsicWidth { throw new UnimplementedNativeFunctionError(); }

  /// The distance from the top of the paragraph to the alphabetic
  /// baseline of the first line, in logical pixels.
  double get alphabeticBaseline { throw new UnimplementedNativeFunctionError(); }

  /// The distance from the top of the paragraph to the ideographic
  /// baseline of the first line, in logical pixels.
  double get ideographicBaseline { throw new UnimplementedNativeFunctionError(); }
  ...
  /// ParagraphStyle].
  bool get didExceedMaxLines { throw new UnimplementedNativeFunctionError(); }

  /// Computes the size and position of each glyph in the paragraph.
  ///
  /// The [ParagraphConstraints] control how wide the text is allowed to be.
  void layout(ParagraphConstraints constraints) => _layout(constraints.width);
  void _layout(double width) { throw new UnimplementedNativeFunctionError(); }

  /// Returns a list of text boxes that enclose the given text range.
  List<TextBox> getBoxesForRange(int start, int end) { throw new UnimplementedNativeFunctionError(); }
  ...
  List<int> _getPositionForOffset(double dx, double dy) { throw new UnimplementedNativeFunctionError(); }
  ...
  List<int> getWordBoundary(int offset) { throw new UnimplementedNativeFunctionError(); }

  // Redirecting the paint function in this way solves some dependency problems
  // in the C++ code. If we straighten out the C++ dependencies, we can remove
  // this indirection.
  void _paint(Canvas canvas, double x, double y) { throw new UnimplementedNativeFunctionError(); }
}
...
class ParagraphBuilder {
  ...
  void _constructor(Int32List encoded, String fontFamily, double fontSize, double lineHeight, String ellipsis, String locale) { throw new UnimplementedNativeFunctionError(); }
  ...
  void _pushStyle(Int32List encoded, String fontFamily, double fontSize, double letterSpacing, double wordSpacing, double height, String locale, List<dynamic> backgroundObjects, ByteData backgroundData, List<dynamic> foregroundObjects, ByteData foregroundData) { throw new UnimplementedNativeFunctionError(); }
  ...
  String _addText(String text) { throw new UnimplementedNativeFunctionError(); }
  ...
  Paragraph build() { throw new UnimplementedNativeFunctionError(); }
}
